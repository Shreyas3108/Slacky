...
from slacky.api.views import SearchTweetAPIView
from slacky.views import TweetListView
...
urlpatterns = [
    ...
    url(r'^tweet/', include('slacky.urls', namespace='tweet')),
    ...
    url(r'^api/tweet/', include('slacky.api.urls', namespace='tweet-api')),
